  ...
  return (
    <footer className="bg-leadgray text-white/60 py-12 border-t border-white/5">
      <div className="container mx-auto px-6">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col items-center justify-center gap-4 text-xs font-light">
          ...
          <a 
            ...
            className="group"
          >
            <span className="text-[10px] uppercase tracking-[0.2em] text-white/30 group-hover:text-white/60 transition-colors">
              Desenvolvido por <span className="font-bold tracking-tight">Unum People Creative Solutions</span>
            </span>
          </a>
        </div>
      </div>
