...
## 🛡️ Regras e Harness
Consulte estritamente o arquivo `docs/site_recriar/spec/RULES.md` para restrições técnicas e comportamentais inquebráveis.

## 📝 Comandos e Contexto Local
Psychology clinic. Next.js 15, Tailwind 4.
